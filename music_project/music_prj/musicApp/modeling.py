...
class PlaylistEmbedding:
    ...
    def write_json(self, data, fname):
        ...
        distutils.dir_util.mkpath("C:/Users/user/Desktop/abc/" + parent)
        with io.open("C:/Users/user/Desktop/abc/" + fname, "w", encoding="utf-8") as f:
    ...
    def get_w2v(self, total, min_count, size, window, sg):
        try:
            print("get_w2v 실행")
            if not (os.path.isfile("C:/Users/user/Desktop/abc/w2v_model.model")):
                ...
                w2v_model.save("C:/Users/user/Desktop/abc/w2v_model.model")
            print("w2v_model 모델 로드")
            self.w2v_model = Word2Vec.load("C:/Users/user/Desktop/abc/w2v_model.model")
        except OSError as e:
    ...
    def make_title_model(self, title_list_detach):
        try:
            ...
            if not (os.path.isfile("C:/Users/user/Desktop/abc/FT_title_model.model")):
                ...
                FT_title_model.save("C:/Users/user/Desktop/abc/FT_title_model.model")
            self.FT_title_model = FT_gensim.load(
                "C:/Users/user/Desktop/abc/FT_title_model.model")
